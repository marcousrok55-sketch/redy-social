...
export default function Button({
  ...
  const variants = {
    ...
    secondary: 'bg-surface-light hover:bg-slate-600 text-white focus:ring-surface-light',
    danger: 'bg-red-500 hover:bg-red-600 text-white focus:ring-red-500',
    ghost: 'bg-transparent hover:bg-surface-light text-text-secondary hover:text-white'
  };
